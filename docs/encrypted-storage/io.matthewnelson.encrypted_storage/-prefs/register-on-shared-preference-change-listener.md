[encrypted-storage](../../index.md) / [io.matthewnelson.encrypted_storage](../index.md) / [Prefs](index.md) / [registerOnSharedPreferenceChangeListener](./register-on-shared-preference-change-listener.md)
